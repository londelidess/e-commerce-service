...
<div>
  <div className="home-container">
    ...
    <p className="centered-content">upbounders® makes premium screen-free toys that reflect what’s special about the joyfully diverse world of today’s kids!</p>
  ...
  <div className="home-container">
    <h2 className="centered-content">upbounders®️ partners with chick-fil-a to celebrate diversity with kids meal toys</h2>
