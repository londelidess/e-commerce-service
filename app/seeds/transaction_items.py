...
def seed_transaction_items():
    ...
    marnie_item = TransactionItem(transaction_id=marnie_transaction_id, product_id=digimon_deck_id, quantity=1, price_at_time_of_purchase=47.97)
    bobbie_item_1 = TransactionItem(transaction_id=bobbie_transaction_id, product_id=camel_up_id, quantity=1, price_at_time_of_purchase=31.99)
    bobbie_item_2 = TransactionItem(transaction_id=bobbie_transaction_id, product_id=pokemon_puzzle_id, quantity=1, price_at_time_of_purchase=19.18)
